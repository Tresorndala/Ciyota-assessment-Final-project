...
<div class="container-fluid flex-grow-1">
  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #d4edda;">
    <form class="container-fluid justify-content-center" method="post" id="registerform">
      ...
      <input type="text" name="classNumber" id="student" class="form-control">
      <button type="submit" name="submit" class="btn btn-success btn-lg ms-3">Done</button>
    </form>
  </nav>
